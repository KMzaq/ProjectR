...
Shader "Port_02/Crack_Exp/CrackExp_Glow"
{
	Properties
	{
		...
		_T_Center_Gra_01("T_Center_Gra_01", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _T_Center_Gra_01;
		uniform float4 _T_Center_Gra_01_ST;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode18 = tex2D( _Tile_Tex, panner20 );
			float temp_output_3_0 = ( pow( tex2DNode18.r , _Main_Pow ) * _Main_Str );
			...
			float2 uv_T_Center_Gra_01 = i.uv_texcoord * _T_Center_Gra_01_ST.xy + _T_Center_Gra_01_ST.zw;
			o.Alpha = ( i.vertexColor.a * ( temp_output_3_0 * ( saturate( distanceDepth13 ) * tex2D( _T_Center_Gra_01, uv_T_Center_Gra_01 ).r ) ) );
		}
...
/*ASEBEGIN
Version=16700
293;886;1586;738;1479.28;276.8646;1.565;True;True
...
Node;AmplifyShaderEditor.SamplerNode;18;-1331.3,-231.3699;Float;True;Property;_Tile_Tex;Tile_Tex;6;0;Create;True;0;0;False;0;8e84dbcdc4fb83e4583958f01ce815d7;8e84dbcdc4fb83e4583958f01ce815d7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;31;-347.7853,696.5652;Float;True;Property;_T_Center_Gra_01;T_Center_Gra_01;10;0;Create;True;0;0;False;0;81c45276fe2918f468c54d09f8c1ca25;81c45276fe2918f468c54d09f8c1ca25;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;35.63965,485.2902;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1056.76,111.77;Float;True;Property;_Main_Tex;Main_Tex;1;0;Create;True;0;0;False;0;aa25b8e437a72ef40a99bf49ab685da2;aa25b8e437a72ef40a99bf49ab685da2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=C363132A5B2CA822AAF31E953EDD7AB854D17DE0